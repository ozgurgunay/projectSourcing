...
namespace EventBusRabbitMQ.Producer
{
    ...
    {
        //bu class ın amacı rabbitmq ya baglanıp istedigimiz event i istedigimiz queue ya publish edebilecek olması
        ...
        {
            //connection olup olmadıgını kontrol ettik
            if (!_persistentConnection.IsConnected)
            {
                _persistentConnection.TryConnect();
            }
            //burada olusturulan policy üzerinden execute işlemleri yapıcaz
            ...
            //burada olusturulan channel da queue olusturduk 
